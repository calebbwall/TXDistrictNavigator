  ...
  return (
    ...
    >
      ...
      <View style={{ marginTop: Spacing.md }}>
        <ThemedText
          type="caption"
          style={[styles.label, { color: theme.secondaryText, marginTop: 0 }]}
        >
          Custom People (optional)
        </ThemedText>
        <View
          style={[
            styles.dropdownButton,
      ...
      <View style={styles.optionRow}>
        <View style={{ flex: 1 }}>
          ...
          <ThemedText type="caption" style={{ color: theme.secondaryText }}>
            Weighted higher in rotation
          </ThemedText>
        </View>
        <Switch
          value={priority === 1}
          onValueChange={(v) => setPriority(v ? 1 : 0)}
        />
      </View>
      ...
      <Modal visible={showOfficialPicker} transparent animationType="slide">
        <View
          style={[
            styles.officialPickerContainer,
            { backgroundColor: theme.backgroundRoot },
          ]}
        >
          <View
            style={[
              styles.officialPickerHeader,
